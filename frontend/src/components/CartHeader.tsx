    ...
    <header className="sticky top-0 z-30 border-b border-zinc-900/80 bg-black/60 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-8 lg:px-12">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/guia"
            className="hidden items-center gap-2 rounded-full border border-cyan-400/40 bg-zinc-950/80 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-cyan-200 shadow-[0_0_18px_rgba(34,197,235,0.55)] transition hover:border-cyan-300/80 hover:text-cyan-50 sm:inline-flex"
          >
          ...
          <Link
            href="/ps-plus"
            className="hidden items-center gap-2 rounded-full border border-amber-400/40 bg-zinc-950/80 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-amber-200 shadow-[0_0_18px_rgba(250,204,21,0.45)] transition hover:border-amber-300/80 hover:text-amber-100 sm:inline-flex"
          >
